...
echo "<table><b><tr><td>Fusion PE Network Identifier</td><td>Current Local Identifier</td><td>IP Address</td><td>Add/Delete this device</td></tr>";

while ($row = mysql_fetch_array($result)) {

echo "<tr><td>" . $row['InterouteSID'] . "</td><td>" . $row['FWLocalIdentifier'] . "</td><td>" . $row['IPAddress'] . "</td></tr>";

}

echo " <table> <tr><td>  </td><td>  </td><td>  </td></tr> </table> ";
